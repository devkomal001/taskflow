    ...
    <div className="space-y-6 max-w-5xl mx-auto transition-colors duration-200">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2.5 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800/80 transition-all shadow-xs disabled:opacity-50 shrink-0"
        >
      ...
      {/* Filters */}
      <div className="flex flex-col gap-3 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/20 p-4 shadow-xs sm:flex-row sm:items-center">
        ...
        <select
          ...
          className="rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950/40 py-3 px-4 text-xs text-slate-700 dark:text-slate-300 focus:outline-none cursor-pointer shrink-0"
        >
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/20 p-6 shadow-xs">
        {filteredLogs.length === 0 ? (
          <div className="py-16 text-center text-slate-500">
            ...
            <p className="text-xs text-slate-400 max-w-xs mx-auto mt-1">No activities matching your query were recorded in this workspace.</p>
          </div>
        ) : (
                ...
                <div className="flex flex-col gap-1.5 md:flex-row md:items-start md:justify-between">
                  <div className="flex gap-3 text-xs leading-relaxed">
                    {log.profile?.avatar_url ? (
                      ...
                      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-200 dark:bg-slate-800 text-slate-600 font-bold border border-slate-300 text-[9px] mt-0.5">
