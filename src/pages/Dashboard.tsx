    ...
    <div className="space-y-6 max-w-7xl mx-auto transition-colors duration-200">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
        <div className="glass-card hover-glow rounded-2xl p-5 shadow-xs transition-all animate-fade-in-up delay-50 opacity-0">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl bg-[#286CFC]/10 p-2 text-[#286CFC]">
              <Layers size={16} />
            </div>
          </div>
        ...
        <div className="glass-card hover-glow rounded-2xl p-5 shadow-xs transition-all animate-fade-in-up delay-100 opacity-0">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl bg-[#4CB5D4]/10 p-2 text-[#4CB5D4]">
              <Folder size={16} />
            </div>
          </div>
          <div className="mt-4 flex items-baseline gap-1.5">
        ...
        <div className="glass-card hover-glow rounded-2xl p-5 shadow-xs transition-all animate-fade-in-up delay-300 opacity-0">
          <div className="flex items-center justify-between">
            ...
            <div className="rounded-xl bg-[#F59E0B]/10 p-2 text-[#F59E0B]">
              <Users size={16} />
            </div>
          </div>
          <div className="mt-4 flex items-baseline gap-1.5">
      ...
      <div 
        ...
        style={{ 
          ...
          border: '1px solid rgba(40, 108, 252, 0.1)',
          boxShadow: '0 2px 12px rgba(40, 108, 252, 0.05)'
        }}
      >
        <h3 className="text-xs font-bold uppercase tracking-wider mb-3 px-1" style={{ color: 'rgba(40, 108, 252, 0.6)' }}>Quick Actions</h3>
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          <button 
            ...
            style={{
              background: 'rgba(40, 108, 252, 0.06)',
              border: '1px solid rgba(40, 108, 252, 0.12)',
              color: 'var(--text-primary, #0d1e3d)',
            }}
            onMouseEnter={e => {
              (e.currentTarget as HTMLElement).style.background = 'rgba(40, 108, 252, 0.12)';
              (e.currentTarget as HTMLElement).style.borderColor = 'rgba(40, 108, 252, 0.25)';
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLElement).style.background = 'rgba(40, 108, 252, 0.06)';
              (e.currentTarget as HTMLElement).style.borderColor = 'rgba(40, 108, 252, 0.12)';
            }}
          >
            <PlusSquare size={14} style={{ color: '#286CFC' }} />
          ...
          >
            <PlusCircle size={14} style={{ color: '#4CB5D4' }} />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div 
          ...
          style={{
            background: 'var(--surface, white)',
            border: '1px solid rgba(40, 108, 252, 0.1)',
            boxShadow: '0 2px 16px rgba(40, 108, 252, 0.05)'
          }}
        >
          <div className="mb-5 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <TrendingUp style={{ color: '#286CFC' }} size={16} />
              <h3 className="text-xs font-bold uppercase tracking-wider" style={{ color: 'var(--text-secondary, rgba(13,30,61,0.6))' }}>Productivity Trends</h3>
            </div>
            <span 
              className="rounded-lg px-2 py-0.5 text-[9px] font-bold"
              style={{
                background: 'rgba(40, 108, 252, 0.1)',
                border: '1px solid rgba(40, 108, 252, 0.2)',
                color: '#286CFC'
              }}
            >Active Log</span>
          </div>
              ...
              <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                <defs>
                  <linearGradient id="colorCompleted" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#286CFC" stopOpacity={0.3}/>
                    <stop offset="95%" stopColor="#286CFC" stopOpacity={0}/>
                  </linearGradient>
                </defs>
                <CartesianGrid strokeDasharray="3 3" stroke={theme === 'dark' ? 'rgba(40, 108, 252, 0.08)' : 'rgba(40, 108, 252, 0.07)'} />
                <XAxis dataKey="week" stroke={theme === 'dark' ? '#A0AEC0' : 'rgba(13, 30, 61, 0.4)'} />
                <YAxis stroke={theme === 'dark' ? '#A0AEC0' : 'rgba(13, 30, 61, 0.4)'} />
                <Tooltip
                  contentStyle={theme === 'dark' ? { backgroundColor: '#07153D', borderColor: 'rgba(40, 108, 252, 0.25)', borderRadius: '12px', color: '#ffffff' } : { backgroundColor: '#ffffff', borderColor: 'rgba(40, 108, 252, 0.15)', borderRadius: '12px' }}
                  labelStyle={theme === 'dark' ? { fontWeight: 'bold', color: '#4CB5D4' } : { fontWeight: 'bold', color: '#0d1e3d' }}
                />
                <Area type="monotone" dataKey="completed" name="Completed Tasks" stroke="#286CFC" strokeWidth={2.5} fillOpacity={1} fill="url(#colorCompleted)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        >
          <div className="mb-5 flex items-center gap-2">
            <Users style={{ color: '#4CB5D4' }} size={16} />
            <h3 className="text-xs font-bold uppercase tracking-wider" style={{ color: 'var(--text-secondary, rgba(13,30,61,0.6))' }}>Workload Distribution</h3>
          </div>

          <div className="h-64 w-full text-[10px]">
            {workloadData.length === 0 ? (
              <div className="flex h-full items-center justify-center" style={{ color: 'rgba(40, 108, 252, 0.4)' }}>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={workloadData} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" stroke={theme === 'dark' ? 'rgba(40, 108, 252, 0.08)' : 'rgba(40, 108, 252, 0.07)'} />
                  <XAxis dataKey="name" stroke={theme === 'dark' ? '#A0AEC0' : 'rgba(13, 30, 61, 0.4)'} />
                  <YAxis stroke={theme === 'dark' ? '#A0AEC0' : 'rgba(13, 30, 61, 0.4)'} allowDecimals={false} />
                  <Tooltip
                    contentStyle={theme === 'dark' ? { backgroundColor: '#07153D', borderColor: 'rgba(40, 108, 252, 0.25)', borderRadius: '12px', color: '#ffffff' } : { backgroundColor: '#ffffff', borderColor: 'rgba(40, 108, 252, 0.15)', borderRadius: '12px' }}
                    labelStyle={theme === 'dark' ? { fontWeight: 'bold', color: '#4CB5D4' } : { fontWeight: 'bold', color: '#0d1e3d' }}
                  />
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        >
          <div className="flex items-center gap-2 pb-3 mb-2" style={{ borderBottom: '1px solid rgba(40, 108, 252, 0.1)' }}>
            <Activity style={{ color: '#286CFC' }} size={16} />
            <h3 className="text-xs font-bold uppercase tracking-wider" style={{ color: 'var(--text-secondary, rgba(13,30,61,0.6))' }}>Recent Workspace Activities</h3>
          </div>

          <div className="space-y-4 max-h-[320px] overflow-y-auto pr-1">
            {activities.slice(0, 10).map((act) => (
              <div key={act.id} className="flex gap-3 text-xs pb-3 last:pb-0" style={{ borderBottom: '1px solid rgba(40, 108, 252, 0.06)' }}>
                {act.profile?.avatar_url ? (
                  <img src={act.profile.avatar_url} alt="" className="h-8 w-8 rounded-full object-cover mt-0.5 shrink-0" style={{ border: '2px solid rgba(40, 108, 252, 0.2)' }} />
                ) : (
                  <div 
                ...
                <div className="overflow-hidden">
                  <p className="leading-relaxed" style={{ color: 'var(--text-primary, #0d1e3d)' }}>
                    ...
                    <span 
                      ...
                      style={{
                        background: 'rgba(40, 108, 252, 0.08)',
                        color: 'var(--text-secondary, rgba(13,30,61,0.6))'
                      }}
                    >
                      {act.target_type}: {act.target_name}
                    </span>
                  </p>
                  <p className="text-[9px] font-semibold mt-1" style={{ color: 'rgba(40, 108, 252, 0.4)' }}>{formatActivityTime(act.created_at)}</p>
                </div>
              </div>
            ))}

            {activities.length === 0 && (
              <div className="py-8 text-center" style={{ color: 'rgba(40, 108, 252, 0.4)' }}>
        ...
        >
          <div className="flex items-center justify-between pb-3" style={{ borderBottom: '1px solid rgba(40, 108, 252, 0.1)' }}>
            <div className="flex items-center gap-2">
              <Users style={{ color: '#4CB5D4' }} size={16} />
              <h3 className="text-xs font-bold uppercase tracking-wider" style={{ color: 'var(--text-secondary, rgba(13,30,61,0.6))' }}>Teammates</h3>
            </div>
            <button 
              onClick={() => navigate('/members')}
              className="flex items-center gap-0.5 text-[10px] font-bold transition-colors"
              style={{ color: '#4CB5D4' }}
              onMouseEnter={e => (e.currentTarget as HTMLElement).style.color = '#286CFC'}
              onMouseLeave={e => (e.currentTarget as HTMLElement).style.color = '#4CB5D4'}
            >
              <span>Directory</span>
              ...
              <div key={member.id} className="flex items-center justify-between">
                <div className="flex items-center gap-2.5 overflow-hidden">
                  {member.profile?.avatar_url ? (
                    <img src={member.profile.avatar_url} alt="" className="h-8 w-8 rounded-full object-cover shrink-0" style={{ border: '2px solid rgba(40, 108, 252, 0.2)' }} />
                  ) : (
                    <div 
                  ...
                  <div className="overflow-hidden">
                    <p className="text-xs font-bold truncate leading-none" style={{ color: 'var(--text-primary, #0d1e3d)' }}>{member.profile?.full_name}</p>
                    <p className="text-[9px] truncate mt-1 leading-none" style={{ color: 'rgba(40, 108, 252, 0.4)' }}>{member.profile?.email}</p>
                  </div>
                </div>
                <span 
